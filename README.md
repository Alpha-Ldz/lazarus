...
[![CI](https://github.com/Alpha-Ldz/lazarus/actions/workflows/ci.yml/badge.svg)](https://github.com/Alpha-Ldz/lazarus/actions/workflows/ci.yml)
...
This project is developed with AI assistance in a structured, deliberate way.

Each change goes through a formal issue (template at [`.github/ISSUE_TEMPLATE/feature.md`](.github/ISSUE_TEMPLATE/feature.md)) with defined scope, acceptance criteria, and executable verification steps. One branch and one pull request per issue; human review before merge.

[`CLAUDE.md`](CLAUDE.md) and [`.clauderules`](.clauderules) document the project conventions used in that workflow — package management, code style, commit format, file layout. They are method artefacts, not editor leftovers.

Architecture decisions and evaluation choices (benchmark protocol, production model selection, documented limits) are made by human review, not generated automatically.
